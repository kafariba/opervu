...
class Ui_MainWindow(object):
    ...
    def rewind(self):
        ...
        if self.currentFrameNumber >= self.saveFrameNumber + 1:
            self.goPosition(-1)
...
if __name__ == '__main__':
    args = ['/home/kamiar/Videos/opervu_videos/Children_Hosp_9-18/Surgery_1.mp4', '/home/kamiar/projects/opervu/images/surgery_images_9_18/', '7720', '42']
    main(args)
