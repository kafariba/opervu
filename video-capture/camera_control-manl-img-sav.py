...
class CMyCallback:
    ...
    def __init__(self, cam_num=""):
        ...
        self.cam_path = ""
        if not os.path.isdir("camera_" + str(cam_num)):
            os.mkdir("camera_" + str(cam_num))
        ...
        while True:
            ...
            if self.cam_state == self.PREVIEWING:
                ...
                for my_callback in self.my_callbacks:
                    ...
                    self.cam_state = self.PREVIEW_DONE
                    self.status_q.put(self.num_cameras)
    ...
    def init_cameras(self):
        try:
            ...
            while True:
                ...
                cam_disp_name = self.st_devices[len(self.st_devices)-1].info.display_name
                ...
                my_callback = CMyCallback(cam_num)
            ...
            for counter, st_datastream in enumerate(self.st_datastreams):
                ...
                callback = st_datastream.register_callback(self.cb_funcs[counter])
