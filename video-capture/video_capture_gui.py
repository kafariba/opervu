...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.recordSpinBox.setGeometry(QtCore.QRect(810, 60, 48, 26))
        self.recordSpinBox.setMaximum(10)
        self.recordSpinBox.setMinimum(1)
        self.recordSpinBox.setSingleStep(1)
        self.recordSpinBox.setProperty("value", 7)
        self.recordSpinBox.setDisplayIntegerBase(10)
        self.recordSpinBox.setObjectName("recordSpinBox")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(860, 56, 161, 31))
